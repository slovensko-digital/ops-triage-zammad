...
RUN sed -i 's/\(seeds = %w\[.*\)\]/\1 ops_custom_settings ops_custom_roles ops_custom_user_fields ops_custom_ticket_fields ops_custom_webhooks ops_custom_triggers]/' db/seeds.rb
