Trigger.find_or_initialize_by(name: '2 - ops - preposielanie nových podnetov PRO zodpovedným subjektom').tap do |trigger|
  trigger.condition = {
...
Trigger.find_or_initialize_by(name: '2 - ops - preposielanie upravených podnetov PRO zodpovedným subjektom').tap do |trigger|
  trigger.condition = {
    "operator" => "AND", "conditions" => [
      { "name" => "ticket.process_type", "operator" => "is", "value" => [ "portal_issue_resolution" ] },
...
Trigger.find_or_initialize_by(name: '2 - ops - preposielanie nových komentárov PRO zodpovedným subjektom').tap do |trigger|
  trigger.condition = {
